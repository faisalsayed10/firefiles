...
<div style="color:#000000;direction:ltr;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;">
<p style="margin: 0;"><strong>- Firefiles Team</strong></p>
</div>
</td>
</tr>
</table>
...
export const inviteText = (url: string, email: string) => `
Dear ${email},

You have a new invitation to a bucket. 
Click on the link below to log in to Firefiles and check it out.

${url}

- Firefiles Team`;

export const inviteHtml = (url: string, email: string) => `<!DOCTYPE html>
<html lang="en" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:v="urn:schemas-microsoft-com:vml">
<head>
<title></title>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/>
...
<td style="padding-left:10px;">
<div style="color:#000000;direction:ltr;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;">
<p style="margin: 0; margin-bottom: 16px;">You have a new invitation to a bucket.</strong>.</p>
<p style="margin: 0; margin-bottom: 16px;">Click the button below to log in to <strong>Firefiles</strong> and check it out.</p>
</div>
</td>
</tr>
</table>
