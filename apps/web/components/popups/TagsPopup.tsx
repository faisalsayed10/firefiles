              ...
              {editingTag === tag ? (
                <>
                  {/* <Input
                    flex="1"
                    value={tag.key}
                    onChange={(e) => setEditingTag((prevTag) => ({ ...prevTag, key: e.target.value }))}
                  />
                  <Input
                    flex="1"
                    ml="2"
                    value={tag.value}
                    onChange={(e) => setEditingTag((prevTag) => ({ ...prevTag, value: e.target.value }))}
                  /> */}
                  <Input
                    flex="1"
                    value={editedTag?.key ?? tag.key}  // Use the editedTag key or fallback to original tag key
                    onChange={(e) => setEditedTag((prevTag) => ({ ...prevTag, key: e.target.value }))}
                  />
                  <Input
                    flex="1"
                    ml="2"
                    value={editedTag?.value ?? tag.value}  // Use the editedTag value or fallback to original tag value
